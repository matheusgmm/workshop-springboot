package com.muccio.springcourse.resources.exceptions;


import com.muccio.springcourse.services.exceptions.DatabaseException;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandartError> resourceNotFound(ResourceNotFoundException e, HttpServletRequest request) {
        String error = "Resource nof found";
